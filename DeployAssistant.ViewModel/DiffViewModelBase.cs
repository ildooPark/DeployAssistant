...
{
    /// <summary>
    /// Shared state and behaviour for windows that display a side-by-side
    /// diff between two <see cref="ProjectData"/> snapshots
    /// (Version Diff, Integration Diff, …).
    /// </summary>
    public abstract class DiffViewModelBase : ViewModelBase
    {
